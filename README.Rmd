...
* **construct** uniform or Hilbert Frank-Wolfe coresets for binary logistic regression data, setting the size of the coreset along with other construction parameters.
...
Please see our [vignette](inst/doc/vanilla_bayesian_coresets.html) for more information and a walk-through of the capabilities of this package.
